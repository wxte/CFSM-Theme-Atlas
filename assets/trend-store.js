...
let timer;
export function flushObservations(){try{sessionStorage.setItem(storageKey,JSON.stringify({version:1,at:Date.now(),nodes:[...observations].slice(-100)}));sessionStorage.setItem('atlas-selections-v1',JSON.stringify([...selections].slice(-100)));}catch{}}
