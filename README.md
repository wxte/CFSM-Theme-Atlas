...
WXT Atlas v0.2.9 提供概览、节点、网络三视图；资源并入概览，活动通过右上角弹层和活动视图查看。无需修改 CFSM 后端，无需构建，无 Vue / React / ECharts；字体、地球脚本与纹理均随主题本地发布，不需要第三方字体 CDN。英文、数字和符号统一使用本地 Geist Sans，中文使用 Atlas UI。
